...
public class RestTemplateExamples {
    ...
    public void updateCustomer() throws Exception {
        ...
        String id = customerUrl.split("/")[3]; // Slpit the string on the "/" and parse out the 3rd value (= id value)

        System.out.println("Created customer id: " + id);

        // Do a PUT against the API
    ...
    public void deleteCustomer() throws Exception {
        ...
        // We try to get the customer, which we just deleted
        // Should go boom on 404. Hence, need the "HttpClientErrorException"
